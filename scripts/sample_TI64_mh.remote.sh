...
--dataset TI64_hdf5 --parallel --shuffle --batch_size 500  \
...
--get_self_error \
--sample_multiple \
--experiment_name mhinge_p1_allimgs_tinyimagenet \
--load_weights '002500,005000,007500,010000,012500,015000,017500,020000,022500,025000,027500,030000,032500,035000,037500,040000,042500,045000,047500,050000,052500,055000,057500,060000,062500,065000,067500,070000,072500,075000'
#--overwrite
