...
--G_eval_mode \
--sample_multiple \
--load_weights '064000,062000,060000,058000,056000,054000,052000,050000'
#--resume
...
# --official_FID \
# --load_weights '098000,094000,090000,086000,082000,078000,074000,070000,066000,062000,058000,054000,050000,046000,042000,038000,034000'
