...
--weights_root /fs/vulcan-scratch/ilyak/locDoc/experiments/cifar10 \
--logs_root /fs/vulcan-scratch/ilyak/locDoc/experiments/cifar10 \
--samples_root /fs/vulcan-scratch/ilyak/locDoc/experiments/cifar10 \
--mh_loss \
--model=BigGANmh \
--sample_np_mem \
--official_IS \
...
--G_eval_mode \
--experiment_name mhs_p05_redofeb1 \
--sample_multiple \
...
--dataset_is_fid /fs/vulcan-scratch/ilyak/locDoc/data/cifar10/fid_is_scores.npz \
--G_eval_mode \
--experiment_name mhs_p05_redofeb2 \
--sample_multiple \
--load_weights '100000,098000,096000,094000,092000,090000,088000,086000,084000,082000,080000,078000,076000,074000,072000,070000,068000,066000,064000,062000,060000,058000,056000,054000,052000,050000,048000,046000,044000,042000,040000,038000,036000,034000,032000,030000,028000,026000,024000,022000,020000,018000,016000,014000,012000,010000,008000,006000,004000,002000'
