...
--dataset TI128_hdf5 --parallel --shuffle --batch_size 100  \
...
--get_train_error \
--sample_multiple \
--experiment_name mhinge_p1_128px \
--load_weights '002500,005000,007500,010000,012500,015000,017500,020000,022500,025000'
#--overwrite
