#!/bin/bash
python train.py \
--dataset TI64_hdf5 --parallel --shuffle --batch_size 128  \
--num_workers 6 --num_G_accumulations 1 --num_D_accumulations 1 \
--num_D_steps 2 --G_lr 1e-4 --D_lr 8e-4 --D_B2 0.999 --G_B2 0.999 \
--G_attn 0 --D_attn 0 \
--num_epochs 500 \
...
--data_root /scratch2/ilyak/locDoc/data/tiny-imagenet \
--weights_root /scratch2/ilyak/locDoc/BigGAN \
--logs_root /scratch2/ilyak/locDoc/BigGAN \
--samples_root /scratch2/ilyak/locDoc/BigGAN \
--test_every 1000 \
...
--model=BigGANmh \
--load_in_mem \
--experiment_name mhinge_p1_2step_ctd_Dlr8 \
--resume \
--load_weights '050000'
